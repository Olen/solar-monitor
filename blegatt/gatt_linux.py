...
class Device:
    def __init__(self, mac_address, manager, managed=True):
        ...
        # Device needs to be created if it's not yet known to bluetoothd, see "test-device" in bluez-5.43/test/
...
class Characteristic:
    ...
    def __init__(self, service, path, uuid):
        # Don't require `path` parameter, it can be calculated from service's path and uuid
